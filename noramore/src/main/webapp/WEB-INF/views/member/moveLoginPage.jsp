...
<div id="box_in">
	<form  name= "로그인" action="login.do" method="post">
		<h1 >로그인</h1>
		<label><input type="text" name="memberID" id="mid" class="pos" placeholder=" Id" autocomplete="off"></label>
		<label><input type="password" name="memberPWD" id="mpwd" class="pos" placeholder=" Password" autocomplete="off"></label>
  ...
  <input type="checkbox" id="idSaveCheck"><br>
	...
	<div id="k_id_login" class="social_login" style="text-align:center;">
		...
		<a href="${ kurl }" class="cp">
			<img src="${ pageContext.servletContext.contextPath }/resources/images/kakao_login.png" alt="카카오 로그인" id="kimg">
		</a>
	</div> 
	    <!-- 네이버 로그인 창으로 이동 -->
	 <div id="naver_id_login" class="social_login" style="text-align:center;">
		<c:url var="nurl" value="${ requestScope.naverurl }" />
		<a href="${ nurl }" class="cp">
			<img src="${ pageContext.servletContext.contextPath }/resources/images/naver_login.png" alt="네이버 로그인" id="nimg">
		</a>
	</div>  
