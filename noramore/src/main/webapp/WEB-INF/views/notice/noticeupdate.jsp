...
<body>
	<br>
	<form action="nupdate.do?boardId=${notice.boardId}" method="post"
		enctype="multipart/form-data">
		<input type="hidden" name="boardId" value="${ notice.boardId }">
		<input type="hidden" name="originalFilePath"
			value="${notice.originalFilePath }"> <input type="hidden"
			name="renameFilePath" value="${notice.renameFilePath }">

		<section id="write">
			<!-- 공지 수정 제목 및 버튼 -->
			<h1 align="center">${notice.title}수정하기</h1>
			<div class="line"></div>
			<br>
			<table>
				<tr>
