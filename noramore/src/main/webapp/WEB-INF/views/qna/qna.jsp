...
<body>
	<section id="board">
		...
		<%-- 제목 검색 폼 --%>
		<form id="titleform" class="sform" action="qsearchTitle.do"
			method="get">
		...
		<%-- 내용 검색 폼 --%>
		<form id="contentform" class="sform" action="qsearchContent.do"
			method="get">
		...
		<%-- 등록날짜 검색 폼 --%>
		<form id="dateform" class="sform" action="qsearchDate.do" method="get">
